...
// No ImportModal stub needed any more (spec-import-document-page):
// "Importer un document" is now a plain `Link` in Sidebar.vue, not a
// component that calls `useForm()` at setup time.
